            ...
            <div class="border-b border-gray-900/10 pb-12">
                ...
                <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <x-form-field>
                        ...
                        <div class="mt-2">
                            <x-form-input id="email" name="email" type="email" placeholder="john@example.com" required />
                    ...
                    <x-form-field>
                        ...
                        <div class="mt-2">
                            <x-form-input id="password_confirmation" name="password_confirmation" placeholder="Password Confirmation" required />
